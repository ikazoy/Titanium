...
// in simulator we redefine to format for myfacelogsample Developer console
...
{\
	NSString * exceptionName = [@"org.myfacelogsample." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myfacelogsample";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UImyfacelogsampleNativeItemNone = -1, 
	UImyfacelogsampleNativeItemSpinner = -2,
	UImyfacelogsampleNativeItemProgressBar = -3,
	
	UImyfacelogsampleNativeItemSlider = -4,
	UImyfacelogsampleNativeItemSwitch = -5,
	UImyfacelogsampleNativeItemMultiButton = -6,
	UImyfacelogsampleNativeItemSegmented = -7,
	
	UImyfacelogsampleNativeItemTextView = -8,
	UImyfacelogsampleNativeItemTextField = -9,
	UImyfacelogsampleNativeItemSearchBar = -10,
	
	UImyfacelogsampleNativeItemPicker = -11,
	UImyfacelogsampleNativeItemDatePicker = -12,
	
	UImyfacelogsampleNativeItemInfoLight = -13,
	UImyfacelogsampleNativeItemInfoDark = -14,
	
	UImyfacelogsampleNativeItemDisclosure = -15,
	
	UImyfacelogsampleNativeItemContactAdd = -16
};
