...
@interface myfacelogsampleObject : KrollCoverageObject {
#else
@interface myfacelogsampleObject : KrollObject {
#endif
@private
...
extern NSString * myfacelogsample$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	myfacelogsampleObject *_myfacelogsample;
	BOOL shutdown;
