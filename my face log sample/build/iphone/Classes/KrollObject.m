 ...
 * Copyright (c) 2009-2011 by myfacelogsample, Inc. All Rights Reserved.
...
//@interface myfacelogsampleObject : NSObject
//@end

@interface myfacelogsampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[myfacelogsampleObject class]])
		{
			for (NSString *key in [[(myfacelogsampleObject*)o modules] allKeys])
			{
